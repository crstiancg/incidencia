...
<body class="px-5 m-0 vh-100 row justify-content-center align-items-center">
        ...
        <div class="row align-items-stretch"> 
            ...
            <div class="col bg-white p-5 rounded-end">
                <div class="d-flex align-items-center mb-3 pb-1">
                    <i class="fa fa-desktop fa-2x me-2" style="color: #07bdc3;"></i>
                    <span class="h1 fw-bold mb-0">Login Gore</span>
                  </div>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-grid my-5">
                        <button type="submit" class="btn btn-outline-dark">{{ __('Iniciar Sesión') }}</button>
                    </div>
                </form>
            </div>
        </div>
